...
// Redirect to donate page if a link is given
if(isset($_GET[l]) && $_GET[l] != "")
	header('location:http://charity-x.org/donate.php?l='.$_GET[l]);

// Require class structures
...
<!--  Include JavaScripts  -->
	...
	<script src="js/index.js"></script><!--page specific functions-->
...
<!-- App Bar - This is the fixed tool bar at the top of the page -->
 	...
 	<!-- Primary App Bar - This is the top section of the App bar displaying the menu icons and logo -->
		<div class="PrimaryAppBar">
			...
			<div class="Right">
				<div class="ActionIcon" id="SearchAction"><i class="fa fa-search"></i></div>
				<div class="ActionIcon" id="FilterAction"><i class="fa fa-filter"></i></div>
				<div class="ActionIcon" id="UserMenuAction"><i class="fa fa-user-circle"></i></div>
			</div>
		</div>
	
	<!-- Secondary App Bar is the bottom section of the App Bar displaying 'Challenges' and 'Leaderboard' page title links -->
		<div class="SecondaryAppBar">
			<a class="Slider span-6 Selected" href="index.php">CHALLENGES</a><a class="Slider span-6" href="dashboard.php">DASHBOARD</a>
		</div>
	</header>
...
<!-- Main content area - This is where the challenges (or search results) are displayed -->
    ...
    <!-- App Bar Spacer - This ensures content is displayed below the App Bar (not behind it) -->
		<div class="AppBarSpacer-Double"></div>
		
		<div class="row">
			<div class="col-xs-12">
			<!-- Challenge Suggestions - Challenges are loaded asynchronously using the ChallengeSearch() function in index.js -->
				<div id="ChallengeSuggestions">
					<div >You must enable javascript for this web-app to operate.</div>
				</div>
			</div>
		</div>
